module github.com/mrusme/planor
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/cloudwatchlogs v1.15.1 // indirect
	github.com/aws/aws-sdk-go-v2/service/codepipeline v1.13.0 // indirect
